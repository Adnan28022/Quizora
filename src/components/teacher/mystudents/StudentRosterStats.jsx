...
const StudentRosterStats = () => {
    const stats = [
        { label: "Total Students", val: "1,248", icon: <Users size={20} />, color: "text-indigo-600", bg: "bg-indigo-50" },
        { label: "New Joinees", val: "+140", icon: <UserPlus size={20} />, color: "text-emerald-600", bg: "bg-emerald-50" },
        { label: "Engagement", val: "84%", icon: <HeartPulse size={20} />, color: "text-pink-600", bg: "bg-pink-50" },
        { label: "Verified", val: "1,100", icon: <ShieldCheck size={20} />, color: "text-amber-500", bg: "bg-amber-50" },
    ];
...
export default StudentRosterStats;