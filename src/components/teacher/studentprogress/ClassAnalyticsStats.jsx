...
const ClassAnalyticsStats = () => {
    const stats = [
        { label: "Total Participants", val: "1,248", icon: <Users size={20} />, color: "text-indigo-600", bg: "bg-indigo-50" },
        { label: "Avg. Class Score", val: "78.4%", icon: <Target size={20} />, color: "text-emerald-600", bg: "bg-emerald-50" },
        { label: "Pass Rate", val: "92%", icon: <Award size={20} />, color: "text-amber-500", bg: "bg-amber-50" },
        { label: "Needs Support", val: "14", icon: <AlertCircle size={20} />, color: "text-red-500", bg: "bg-red-50" },
    ];
...
export default ClassAnalyticsStats;